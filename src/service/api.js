...
const URL = "https://discover-doller-backend.onrender.com/api/v1";
...
export const payUsingPaytm = async (data) => {
  try {
    const {
      ...
      "https://discover-doller-backend.onrender.com/api/getkey"
    );

    let {
      data: { order },
    } = await axios.post(`${URL}/payment/checkout`, data);
    const options = {
      key: key,
